...
const article = await fetchArticle()
  ...
  const data = '<title>CBC News</title><meta content="' + detailHeadline + '" property="og:title" /><meta content="' + detailSummary + '" property="og:description" /><meta content="' + detailImage + '" property="og:image" /><meta content="' + c.req.url.replace("fxcbc","cbc") + '" property="og:url" /><meta property="og:image:width" content="'+ imageWidth + '/><meta property="og:image:height" content="'+ imageHeight + '"/><meta content="#43B581" data-react-helmet="true" name="theme-color" /><script>window.onload = window.location.replace(\'' + c.req.url.replace("fxcbc","cbc") + '\')</script>';
